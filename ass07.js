...
function handler(req, res) {
    fs.readFile(__dirname + "/ass07.html",
    function (err, data) {
        if (err) {
...
function controlAlgorithm (parameters) {
   if (parameters.ctrlAlgNo == 1) {
    ...
    if (parameters.ctrlAlgNo == 2) { pwm = parameters.Kp1*err + parameters.Ki1*errSum + parameters.Kd1*dErr};
};
